...
// import '../../assets/images/group/1.jpg';
import groupImage from '../../assets/images/group/1.jpg';
            ...
            <div className="banner">
              ...
              <div className="flex items-center justify-center bg-black w-full h-[400px] rounded-lg relative">
                ...
                <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-60 p-4 rounded-b-lg">
                  <h4 className="text-white text-lg font-semibold">Vi tích phân A1</h4>
                  <span className="text-white text-sm">Phần 1</span>
